...
public class ChessMatch {
	...
	public ChessMatch () {
		...
		// poderia enfatizar que a propriedade check (que é um boolean) começa com  = false; porém já é p padrão e nao há necessidade
		
		// as listas poderiam ser instanciadas aqui no construtor--> piecesOnTheBoard = new ArrayList<>();
	}
